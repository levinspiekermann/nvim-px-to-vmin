local nvim_px_to_vmin_cmp = require("nvim-px-to-vmin.integrations.cmp")
...
describe("cursor_str", function()
	...
	it("should not match other units", function()
		--                                                                    |12
		local input, _, _ = utils.get_start_of_word_under_cursor("font-size: 12vmin;", 12)
		assert.equal("", input)
		--                                                                    |12
...
describe("cmp", function()
	it("should match every possiblity to write px value in css", function()
		local keyword_pattern = nvim_px_to_vmin_cmp.get_keyword_pattern()
		local test_values = {
			"font-size: 16px",
			"font-size: 16.5px",
			"font-size: 16",
